...
fun convertNumericQualityToImage(quality: Int): Int{
    var image = R.drawable.ic_sleep_3
    when(quality){
        0 -> image = R.drawable.ic_sleep_0
        1 -> image = R.drawable.ic_sleep_1
        2 -> image = R.drawable.ic_sleep_2
        3 -> image = R.drawable.ic_sleep_3
        4 -> image = R.drawable.ic_sleep_4
        5 -> image = R.drawable.ic_sleep_5
